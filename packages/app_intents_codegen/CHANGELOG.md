...
> type is now generated by default. If you had that flag set but were **not**
> passing `--experimental=value-query`, the query appears in your generated
> Swift for the first time — make sure a Dart `<entity>ValueQuery` handler
> exists. Everyone else is unaffected.
