...
/// Flags that used to select an experimental feature but have since graduated
/// to normal, always-on generation because the symbol turned out to exist in
/// the released SDK.
///
/// They stay recognized so an existing build script keeps working; the CLI
/// prints why the flag is now a no-op instead of silently ignoring it.
